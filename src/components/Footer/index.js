    ...
    return (
        <div className='relative w-full'>
            ...
            <footer className="relative pt-8 pb-6 rounded-4xl">
                    <div className="container px-4 mx-auto">
                        ...
                        <div className="flex w-full flex-wrap text-left lg:text-left">
                            <div className="w-full lg:w-6/12 px-4 flex flex-col items-center justify-center md:justify-between md:items-between md:flex-row sm:mb-8 md:mb-0">
                                ...
                                <h3 className="text-xl italic font-semibold text- mt-2 xsm:text-center md:text-left">Where culture resonates</h3>
                            ...
                            <div className="w-full lg:w-6/12 md:px-4">
                                <div className="flex sm:flex-row xsm:flex-col items-top mb-6 sm:pt-6 md:pt-6 lg:pt-2">
                                    <div className="w-full lg:w-4/12 px-4 mx-auto sm:flex sm:flex-col sm:justify-center sm:items-center md:justify-start md:items-start sm:pl-12">
                                        ...
                                        <ul className="list-unstyled cl-effect-1 SMN_effect-24">
                                            <li>
                                                <a className="text-blueGray-600 hover:text-blueGray-800 font-weight-600 block pb-2 text-md pt-2 anim" to="/" href="/">Home</a>
                                                <hr className='hr-13'/>
                                            </li>
                                            <li>
                                                <a className="text-blueGray-600 hover:text-blueGray-800 font-weight-600 block pb-2 text-md pt-2 fancy3" to="/events" href="/events">Events</a>
                                                <hr className='hr-13'/>
                                            </li>
                                            <li>
                                                <a className="text-blueGray-600 hover:text-blueGray-800 font-weight-600 block pb-2 text-md pt-2 fancy3" to="/sponsors" href="/sponsors">Sponsors</a>
                                                <hr className='hr-13'/>
                                            </li>
                                            <li>
                                                <a className="text-blueGray-600 hover:text-blueGray-800 font-weight-600 block pb-2 text-md pt-2 anim" to="/team" href="/team">Team</a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <hr className="my-4 border-blueGray-300"></hr>
