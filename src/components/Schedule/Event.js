...
function Event(props) {
    return (
        <div style={{minHeight:"50px", maxHeight:"100px" ,width:props.height*100-10, backgroundImage:getGradient(props.t,props.height), height:props.width, margin:"5px", position: "absolute", zIndex:"2", left: (props.row+1)*(min(props.width,100)+5), borderRadius:"10px", 
