        ...
        <>
          <div className="mx-0 max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center md:hidden z-[2000]">
                {/* Mobile menu button*/}
              ...
              <div className="flex flex-1 max-[888px]:items-center max-[888px]:justify-center min-[888px]:items-stretch min-[888px]:justify-start">
                  ...
                  <div className="flex space-x-4 mylinkdecor items-center justify-center menu-hover-effect menu-hover-effect-1">
                    ...
                    <Fragment>
                      
                      {
                        ...
                        <button
                        onClick={logout}
                        className="btn btn-3 logout text-white px-2 py-3 rounded-md text-sm font-semibold font-mont"
                      >
                        Logout
                      </button>
                      <Link to={"/profile"}
                        className="btn btn-3 text-white px-2 py-3 rounded-md text-sm font-semibold font-mont"
                      >
                        Profile
                      </Link>
                      </> ) : (
          ...
          <Disclosure.Panel className='backdrop-filter backdrop-blur-lg opacity-90 w-full'>
            <div className="space-y-1 px-2 pt-2 pb-3 beaut md:hidden font-semibold font-mont">
              {navigation.map((item) => (
                <Disclosure.Button
                  key={item.name}
                  as="a"
