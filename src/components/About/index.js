    ...
    return (
        <div className="w-full p-4 bg-gradient-to-t from-[#000000] to-black text-white">
            ...
            <div className="about-theme flex flex-row-reverse flex-wrap justify-center justify-items-center items-center gap-4 p-4 mb-10">
                <h1 className="flex-[100%] text-center font-bold text-4xl uppercase bg-gradient-to-r from-[#FFFFFF] to-[#F7CA17] inline-block text-transparent pb-5 bg-clip-text">About The Theme</h1>
                <div className="sm:w-[100%] md:w-[45%] flex justify-center items-center">
